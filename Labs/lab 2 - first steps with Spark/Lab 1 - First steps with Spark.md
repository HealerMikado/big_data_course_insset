...
- Load the json file store here : `s3://spark-lab-input-data-ensai20222023/tweets/tweets20220324-155940.jsonl.gz` and name you DataFrame`df_tweet`
...
- It's possible to load multiple file in a unique DataFrame. It's useful when you have daily files and want to process them all. It's the same syntax as the previous one, just specify a folder. Like `s3n://spark-lab-input-data-ensai20222023/tweets/`. Name you DataFrame `df_tweet_big`
